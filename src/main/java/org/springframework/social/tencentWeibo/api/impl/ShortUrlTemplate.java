 ...
 * @author Gavin.Lin
 */
class ShortUrlTemplate extends AbstractTencentWeiboOperations implements ShortUrlOperations {

    private RequestAPI requestAPI;

    public ShortUrlTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
