 ...
 * @author Gavin.Lin
 */
class FavoriteTemplate extends AbstractTencentWeiboOperations implements FavoriteOperations {

    private RequestAPI requestAPI;

    public FavoriteTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
