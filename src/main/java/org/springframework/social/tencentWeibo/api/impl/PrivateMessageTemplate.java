 ...
 * @author Gavin.Lin
 */
class PrivateMessageTemplate extends AbstractTencentWeiboOperations implements PrivateMessageOperations {

    private RequestAPI requestAPI;

    public PrivateMessageTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
