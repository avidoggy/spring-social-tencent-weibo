 ...
 * @author Gavin.Lin
 */
class VoteTemplate extends AbstractTencentWeiboOperations implements VoteOperations {

    private RequestAPI requestAPI;

    public VoteTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
