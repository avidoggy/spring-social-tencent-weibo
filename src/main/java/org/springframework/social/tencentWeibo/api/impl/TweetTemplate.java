 ...
 * @author Gavin.Lin
 */
public class TweetTemplate extends AbstractTencentWeiboOperations implements TweetOperations {

    private RequestAPI requestAPI;

    public TweetTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
