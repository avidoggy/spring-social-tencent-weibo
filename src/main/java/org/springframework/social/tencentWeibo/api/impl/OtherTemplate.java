 ...
 * @author Gavin.Lin
 */
class OtherTemplate extends AbstractTencentWeiboOperations implements OtherOperations {

    private RequestAPI requestAPI;

    public OtherTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
