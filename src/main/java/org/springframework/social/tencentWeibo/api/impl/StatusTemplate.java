 ...
 * @author Gavin.Lin
 */
class StatusTemplate extends AbstractTencentWeiboOperations implements StatusOperations {

    private RequestAPI requestAPI;

    public StatusTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
