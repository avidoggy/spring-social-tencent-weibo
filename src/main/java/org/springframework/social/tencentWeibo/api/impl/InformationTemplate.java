 ...
 * @author Gavin.Lin
 */
class InformationTemplate extends AbstractTencentWeiboOperations implements InformationOperations {

    private RequestAPI requestAPI;

    public InformationTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
