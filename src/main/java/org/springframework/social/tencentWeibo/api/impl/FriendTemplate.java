 ...
 * @author Gavin.Lin
 */
class FriendTemplate extends AbstractTencentWeiboOperations implements FriendOperations {

    private RequestAPI requestAPI;

    public FriendTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
