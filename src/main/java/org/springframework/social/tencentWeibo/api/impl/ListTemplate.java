 ...
 * @author Gavin.Lin
 */
class ListTemplate extends AbstractTencentWeiboOperations implements ListOperations {

    private RequestAPI requestAPI;

    public ListTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
