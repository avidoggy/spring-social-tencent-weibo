 ...
 * @author Gavin.Lin
 */
class NotificationTemplate extends AbstractTencentWeiboOperations implements NotificationOperations {

    private RequestAPI requestAPI;

    public NotificationTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
