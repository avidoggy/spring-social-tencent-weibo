 ...
 * @author Gavin.Lin
 */
class HotTweetTemplate extends AbstractTencentWeiboOperations implements HotTweetOperations {

    private RequestAPI requestAPI;

    public HotTweetTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
