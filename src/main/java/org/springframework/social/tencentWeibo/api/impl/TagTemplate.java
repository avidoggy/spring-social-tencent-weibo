 ...
 * @author Gavin.Lin
 */
public class TagTemplate extends AbstractTencentWeiboOperations implements TagOperations {

    private RequestAPI requestAPI;

    public TagTemplate(RequestAPI requestAPI, boolean isAuthorizedForUser) {
